...
@jmthon.ar_cmd(
    ...
    info={
        "header": "للحصول على ايدي المجموعة أو المستخدم",
        "description": "إذا تم وضعت معرف او بالرد على شخص ، فسيظهر ايدي المستخدم او القناه او المجموعه ، إذا قمت بالرد على المستخدم ثم يعرض ايدي المستخدم الذي تم الرد عليه /
         مع ايدي الدردشة الحالي وإذا لم يتم الرد على المستخدم أو وضع معرف معين ، فيقوم بإظهار ايدي الدردشة حيث استخدمت الأمر",
        "usage": "{tr}الايدي <بالرد/معرف>",
    },
)
async def _(event):
