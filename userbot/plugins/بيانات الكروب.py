...
async def get_users(show):
    ...
    jmthonevent = await edit_or_reply(show, "**⌯︙جـاري سحـب قائمـة معرّفـات الأعضـاء 🝛**")
    try:
...
async def info(event):
    ...
    try:
        ...
        await jmthonevent.edit("**⌯︙حـدث خـطأ مـا، يرجـى التحقق من الأمـر ⎌**")
...
async def get_chatinfo(event, jmthonevent):
    ...
    try:
        ...
        try:
            ...
            await jmthonevent.edit("**⌯︙لـم يتـمّ العثـور على القنـاة/المجموعـة ✕**")
            return None
            ...
            await jmthonevent.edit("**⌯︙القنـاة أو المجموعـة الخارقـة غيـر موجـودة ✕**")
            return None
