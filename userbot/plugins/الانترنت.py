...
@jmthon.ar_md(
    ...
    info={
        "header": "لاختبار سرعه النت الخاصه ببوتك.",
        "options": {
            "نص": "لاظهار النتيجه على شكل نص",
            "صورة": "لاظاهر النتيجه على شكل صورة",       
            "ملف": "لاظهار النتيجه على شكل ملف.",
        },
        "usage": ["{tr}الانترنت <الخيار>", "{tr}الانترنت"],
    },
)
async def _(event):
    "لاختبار سرعه النت الخاصه ببوتك."
